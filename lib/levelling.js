...
export const xpRange = (level, multiplier = global.multiplier || 1) => {
...
export const findLevel = (xp, multiplier = global.multiplier || 1) => {
...
export const canLevelUp = (level, xp, multiplier = global.multiplier || 1) => {
